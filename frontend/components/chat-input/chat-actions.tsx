...
export const chatOptions = [
    {
        label: 'Research',
        description: 'Deep multi-source research with AI synthesis',
        value: ChatMode.Research,
        icon: <IconAtom size={16} className="text-muted-foreground" strokeWidth={2} />,
        creditCost: CHAT_MODE_CREDIT_COSTS[ChatMode.Research],
    },
    {
        label: 'Quick',
        description: 'Fast single-query answer',
        value: ChatMode.Quick,
        icon: <IconBolt size={16} className="text-muted-foreground" strokeWidth={2} />,
        creditCost: CHAT_MODE_CREDIT_COSTS[ChatMode.Quick],
    },
];

// No separate model options needed — Research and Quick cover everything
export const modelOptions: typeof chatOptions = [];
...
export const ChatModeButton = () => {
    ...
    const selectedOption =
        chatOptions.find(option => option.value === chatMode) ?? chatOptions[0];
